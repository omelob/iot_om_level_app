...
// para guardar el Id del recurso
...
//https://docs.emqx.io/en/broker/v4.2/advanced/http-api.html#interface-security
...
async function listResources() {
    ...
    try {
        ...
        //las respuestas axios y emqx siempre vienen por data entonces: res.data.data
...
// check if superuser exist insted we create one
...
// llamamos la funcion un seg despues de arrancar node
setTimeout(() => {
